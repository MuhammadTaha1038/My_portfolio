...
import { LayoutDashboard, FolderKanban, Code2, Briefcase, LogOut } from "lucide-react"
...
export default async function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex text-white font-sans">
      {/* Sidebar */}
      <aside className="w-64 border-r border-white/5 bg-[#0F0F0F] flex flex-col hidden md:flex">
