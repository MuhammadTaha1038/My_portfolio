    ...
    <footer className="relative border-t border-accent/10 bg-black mt-auto z-40">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-12 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-text-muted text-sm leading-relaxed mb-6">
              Software Engineer & Applied Data Scientist specializing in ML pipelines and scalable backend architectures.
            </p>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              <li><Link href="/" className="text-text-muted hover:text-accent transition-colors text-sm">Home</Link></li>
              <li><Link href="/about" className="text-text-muted hover:text-accent transition-colors text-sm">About</Link></li>
              <li><Link href="/projects" className="text-text-muted hover:text-accent transition-colors text-sm">Projects</Link></li>
            </ul>
          </div>

          {/* Career */}
          <div>
            <h4 className="text-white font-semibold mb-4">Career</h4>
            <ul className="flex flex-col gap-3">
              <li><Link href="/experience" className="text-text-muted hover:text-accent transition-colors text-sm">Experience</Link></li>
              <li><Link href="/certificates" className="text-text-muted hover:text-accent transition-colors text-sm">Certificates</Link></li>
              <li><Link href="/contact" className="text-text-muted hover:text-accent transition-colors text-sm">Contact</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-text-muted text-sm">&copy; {year} Muhammad Taha. All rights reserved.</p>
