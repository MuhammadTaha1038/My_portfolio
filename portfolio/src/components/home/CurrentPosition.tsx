...
const CURRENT_ROLE = {
  role: "Applied Data Scientist & Backend Engineer",
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-16">
            ...
            <div className="lg:w-72 shrink-0">
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xs font-mono text-green-400">{CURRENT_ROLE.status}</span>
              </div>
              ...
              <div className="glass-card rounded-2xl p-5 border border-white/8">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div>
                    <p className="font-semibold text-white text-sm leading-snug">{CURRENT_ROLE.role}</p>
                    <p className="text-accent font-mono text-xs mt-1">{CURRENT_ROLE.company}</p>
                  </div>
                </div>
            ...
            <div className="flex-1">
              ...
              <div className="space-y-4">
                {CURRENT_ROLE.highlights.map((h, i) => (
                  <div
                    key={i}
